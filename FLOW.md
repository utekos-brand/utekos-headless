...
| Klarna-kandidat       | `codex/release-klarna-product-cards` flytter Express Checkout til tilgjengelige produktkort og bruker én delt, idempotent SDK-loader per dokument. Kontrollert lokal browser-smoke viser synlige knapper og korrekt variantbytte ved 390 px og 1440 px. Dette beviser vår rendring, ikke Klarna-providerens aksept. Reell preview-smoke krever verifisert `NEXT_PUBLIC_KLARNA_CLIENT_ID` og tillatte Preview-/Production-origins hos Klarna. |
