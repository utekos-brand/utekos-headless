...
| 4. Provider dispatch | Meta/Google har store mengder `succeeded`; retry/dead-letter-ruter finnes, og all historisk radgjeld er klassifisert/lukket uten blind replay. | Den scoped browser-rettingen er live og backloggaten er grønn, men den sentrale GA4-sanitizeren er fortsatt release-kandidat frem til denne releasen er deployet. | Nye eller fremtidige serverkall må ikke kunne omgå `page_location`-grensen. | Deployer den sentrale sanitizeren, kjør produksjonssmoke og behold provider-rapporten på 0 failed/dead-lettered, 0 unresolved og 0 alerts. |
...
| --------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Lukket 2026-07-14 | Google `page_location` dead letters | 48 historiske rader er klassifisert/lukket uten replay; 0 nye etter scoped deploy, og rapportgaten har 0 failed/dead-lettered, 0 unresolved og 0 alerts | Deployer den sentrale sanitizeren og overvåk samme rapportgate etter produksjon | Fortsatt 0 nye feil med samme grunn og grønn `--fail-on-alerts` |
