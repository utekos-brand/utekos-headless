...
| Område                | Funn                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Meta browser/server-paritet | Web-GTM v121 er live med kanonisk Meta Pixel-tag `153`, trigger `152` og `autoConfig=false`. Produksjonssmoken passerte forside, produkt- og kampanjelanding: null Meta før marketing-samtykke, korrekte/stabile `fbclid`/`fbc`/`fbp`/`external_id`, samme `event_id` i Pixel og CAPI, 200 fra `/tr` og OpenBridge, ingen uventede Pixel-events og ingen Meta-CSP-brudd. Fem korrelerte PageView/ViewContent-rader finnes nøyaktig én gang i ledger/outbox med `eventsReceived=1`, tom provider-`messages`, trace-ID og 0 uløste Meta dead letters. |
...
| P1        | Identifier coverage                     | Siste Meta-øyeblikksbilde: PageView EMQ 6.6, ViewContent 5.5, AddToCart 6.3, InitiateCheckout 5.9 og Purchase 9.3. Pixel-pariteten er direkte bevist, men Metas kildeuttrekk hadde ennå ikke registrert de ferske browser-PageView/ViewContent-eventene. | Mål `client_id`, `fbp`, `fbc`, `external_id` og betalt klikk-ID per event etter 7 og 14 dager; les kildefordelingen på nytt etter provider-etterslepet. | Coverage-rapport per eventtype og consent state med tilstrekkelig denominator. |
