  ...
  return (
    <DrawerPortal data-slot='drawer-portal'>
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className='bg-muted mx-auto mt-4 hidden h-1.5 w-[100px] shrink-0 rounded-full bg-muted group-data-[vaul-drawer-direction=bottom]/drawer-content:block' />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn(
        'text-muted-foreground text-sm text-muted-foreground',
        className
      )}
      {...props}
    />
