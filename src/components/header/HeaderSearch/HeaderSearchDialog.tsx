  ...
  return (
    <CommandDialog
      ...
      className={cn(
        ...
        'ring-ring/20 border border-border ring-2 ring-ring/20',
        'backdrop-blur-md',
        className
      )}
      ...
      <Command className='h-full rounded-none bg-transparent'>
        ...
        <CommandList className='no-scrollbar min-h-80 scroll-pt-2 scroll-pb-1.5'>
          <Suspense
            fallback={
              <div className='p-2'>
                <div className='bg-muted mb-4 h-5 w-1/4 animate-pulse rounded-md bg-muted' />
                <div className='space-y-2'>
                  <div className='bg-muted h-8 w-full animate-pulse rounded-md bg-muted' />
                  <div className='bg-muted h-8 w-full animate-pulse rounded-md bg-muted' />
                  <div className='bg-muted h-8 w-full animate-pulse rounded-md bg-muted' />
                </div>
              </div>
