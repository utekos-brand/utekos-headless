...
export function TrustContentView({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'relative z-20 flex flex-col justify-between rounded-md bg-[color-mix(in_oklch,var(--color-card)_82%,var(--color-background)_18%)] p-4 px-8 text-card-foreground md:py-6'
      )}
    >
      <div className='mb-2'>
