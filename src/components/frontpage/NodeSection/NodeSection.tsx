  ...
  return (
    ...
    >
      <hgroup className='mx-auto text-left text-foreground'>
        ...
        <Lead
          Text='Våre beste produktutviklere er kundene våre. Vi lytter, lærer og designer for at at du kan skape flere og bedre minner utendørs.'
          className='text-foreground/90 font-utekos-text! mt-2 max-w-3xl'
        />
      </hgroup>
