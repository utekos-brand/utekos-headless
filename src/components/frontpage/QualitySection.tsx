              ...
              >
                ...
                <div className='relative z-10 text-left'>
                  ...
                  <P className='w-full text-left text-lg text-card-foreground not-first:mt-0 md:max-w-xl'>
                    Fra den lette spensten i dunet til
                    slitestyrken i hver søm – vi er transparente
                    om materialvalgene som definerer Utekos.
                    Dette er kvalitet du kan føle på, designet
                    for å vare.
                  </P>
                </div>
              </div>
