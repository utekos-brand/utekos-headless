...
import { USERCENTRICS_CHATBASE_SERVICE_NAME } from '@/components/cookie-consent/usercentricsConfig'
...
export function ConsentGatedServices() {
  ...
  const hasChatbaseConsent = useConsentForService(USERCENTRICS_CHATBASE_SERVICE_NAME)
