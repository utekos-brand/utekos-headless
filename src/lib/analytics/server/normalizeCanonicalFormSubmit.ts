import {
  ...
  type CanonicalFormSubmit
} from '../formSubmitEvent'
import type { CanonicalPurchaseRequestContext } from './normalizeCanonicalPurchase'

export type CanonicalFormSubmitRequestContext =
  CanonicalPurchaseRequestContext

export function normalizeCanonicalFormSubmit(
  payload: unknown,
  requestContext: CanonicalFormSubmitRequestContext
): CanonicalFormSubmit {
  const parsed = canonicalFormSubmitSchema.parse(payload)
  ...
  return canonicalFormSubmitSchema.parse(normalized)
}
