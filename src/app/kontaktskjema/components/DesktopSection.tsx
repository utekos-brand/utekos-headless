    ...
    <div className='hidden lg:grid lg:grid-cols-2'>
      <div className='flex flex-col'>
        <div className='grow p-8 lg:p-12'>
          ...
          <p className='leading-text-paragraph text-foreground/90 mt-4 max-w-xl text-xl tracking-normal text-foreground/90'>
            Vi er her for å hjelpe deg med alt du måtte lure på.
          </p>

          <ul className='mt-8 space-y-8'>
            <li className='flex items-start gap-4'>
              <HelpCircle className='shrink-0 text-secondary h-6 w-6' />
              <div>
                <h3 className='leading-tight tracking-normal font-semibold text-foreground'>
                  Få personlig veiledning
                </h3>
                <p className='leading-text-paragraph text-foreground/90 mt-1 text-base tracking-normal text-foreground/90'>
            ...
            <li className='flex items-start gap-4'>
              <Package className='shrink-0 text-secondary h-6 w-6' />
              <div>
        ...
        <div className='border-y border-foreground/12'>
          <div className='grid grid-cols-1 sm:grid-cols-2'>
            <div className='border-r border-foreground/12 p-6 sm:p-8 lg:px-8 lg:py-12'>
              ...
              <p className='leading-text-paragraph text-foreground/90 mt-2 max-w-prose text-base tracking-normal text-foreground/90'>
            ...
            <div className='p-6 sm:p-8 lg:px-8 lg:py-12'>
              <h4 className='leading-tight tracking-normal flex items-center gap-2 font-semibold text-foreground'>
        ...
        <div className='p-8 lg:p-12'>
          <blockquote className='leading-text-paragraph text-foreground/90 text-lg tracking-normal text-foreground/90 italic'>
      ...
      <div className='bg-background/72 border-l border-foreground/12 bg-background/72 p-8 lg:p-12'>
