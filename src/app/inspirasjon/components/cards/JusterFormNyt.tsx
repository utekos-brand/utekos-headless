...
export function JusterFormNyt() {
  return (
    <div
      className='dark:border-dark-foreground/24 relative isolate w-fit shrink-0 self-start rounded-xl border border-foreground/24 px-5 py-3 shadow-md sm:self-center'
