  ...
  return (
    <section className='overflow-x-clip bg-card px-6 py-24 text-card-foreground sm:py-32 lg:px-8'>
      <div className='mx-auto max-w-4xl text-center'>
        ...
        <p className='mt-2 text-5xl font-semibold tracking-tight text-balance text-inherit sm:text-6xl'>
          Velg din favoritt
        </p>
      </div>
      ...
      <div className='mx-auto mt-16 grid w-full max-w-lg min-w-0 grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2'>
        <div className='rounded-3xl rounded-t-3xl bg-background p-8 text-foreground ring-1 ring-border sm:rounded-b-none sm:p-10 lg:rounded-tr-none lg:rounded-bl-3xl'>
          ...
          <p className='mt-4 flex items-baseline gap-x-2'>
            <span className='text-5xl font-semibold tracking-tight text-inherit'>
              1590
            </span>
            <span className='text-base text-inherit/90'>kr</span>
          </p>
          <p className='mt-6 text-base/7 text-inherit/90'>
          ...
          >
            <li className='flex gap-x-3'>
              <svg
                ...
                data-slot='icon'
                aria-hidden='true'
                className='h-6 w-5 flex-none text-ceramic'
              >
                <path
        ...
        <div className='relative rounded-3xl bg-muted p-8 text-foreground ring-1 ring-border sm:p-10'>
          <h3
            id='utekos-techdown'
            className='text-base/7 font-semibold text-inherit'
          >
