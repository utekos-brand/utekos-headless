...
export function AboutHero({
  ...
  return (
    <article className='bg-background relative isolate flex min-h-[82svh] items-center justify-center overflow-hidden bg-background text-foreground md:min-h-[89vh]'>
      <Image
        src={imageSrc}
        alt={imageAlt}
        fill
      ...
      />
      <div className='bg-background/68 absolute inset-0 -z-10 bg-background/68' />
      <div className='from-background via-background/80 absolute inset-x-0 bottom-0 -z-10 h-1/2 bg-linear-to-t from-background via-background/80 to-transparent' />
