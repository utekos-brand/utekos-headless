...
export function CompareModelsPageHero() {
  return (
    <article className='bg-background relative isolate min-h-[calc(100svh-12rem)] overflow-hidden bg-background text-foreground'>
      <Image
      ...
      />
      <div className='bg-background/72 absolute inset-0 -z-10 bg-background/72' />
      ...
      <div className='mx-auto flex min-h-[calc(100svh-12rem)] w-full max-w-7xl flex-col justify-end px-[6vw] py-10 sm:py-12 lg:py-16'>
        <div className='max-w-6xl'>
          ...
          <p className='leading-text-paragraph text-foreground/90 mt-7 max-w-2xl text-lg text-foreground/90 sm:text-2xl'>
          ...
          <div className='mt-9 flex flex-wrap items-center gap-4'>
            ...
            <Link
              href='#sammenligning'
              className='hover:text-muted text-base font-medium text-foreground underline decoration-foreground/35 underline-offset-8 transition-colors duration-300'
            >
              Se tabellen
            </Link>
          </div>
