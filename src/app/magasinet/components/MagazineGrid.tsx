      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          <div className='flex flex-col justify-center p-6 sm:p-9 lg:p-12'>
            ...
            <p className='leading-text-paragraph text-background/90 mt-5 text-lg text-background/90'>
              {article.excerpt}
            </p>
            <span className='text-card mt-8 inline-flex items-center gap-2 text-base leading-4 font-semibold'>
              Les hele saken
              <ArrowRight
...
function MagazineArticleCard({
  ...
  return (
    <li>
      <Link
        href={`/magasinet/${article.slug}` as Route}
        className='group border-background/10 block h-full overflow-hidden rounded-lg border border-background/10 bg-foreground transition-transform duration-300 hover:-translate-y-0.5 motion-reduce:transition-none motion-reduce:hover:translate-y-0'
...
export function MagazineGrid({ articles }: MagazineGridProps) {
  ...
  if (!featuredArticle) {
    return (
      <article className='bg-muted text-background py-16 text-background'>
        <div className='container mx-auto px-4'>
  ...
  return (
    <>
      ...
      <article
        className='bg-muted text-background pb-16 text-background sm:pb-24'
