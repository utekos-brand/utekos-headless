...
export function MagazineHeadingBlock({
  ...
  if (block.level === 3) {
    return (
      <div className='pt-4'>
        {block.eyebrow && (
          <p className='mb-3 text-sm leading-4 font-semibold text-card'>
            {block.eyebrow}
          </p>
        )}
        <h3 className='font-sans text-3xl leading-[0.95] font-bold text-balance text-background sm:text-4xl'>
  ...
  return (
    <div className='pt-6'>
      ...
      <h2 className='font-sans text-4xl leading-[0.95] font-bold text-balance text-background sm:text-5xl'>
        <MagazineInlineTitle text={block.text} />
      </h2>
    </div>
  )
