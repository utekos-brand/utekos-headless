...
export function ProductDetailsAccordionSection({
  ...
  return (
    <AccordionItem
      value={id}
      className='group border-ceramic data-open:border-card-foreground/24 data-open:bg-card/70 relative overflow-hidden rounded-xl border-b bg-card text-card-foreground transition-colors duration-200 hover:cursor-pointer data-open:border-card-foreground/24 data-open:bg-card/70'
      style={{ contain: 'layout style paint' }}
    >
      <div className='bg-background/0 group-data-open:bg-card-foreground/8 pointer-events-none absolute inset-0 z-0 bg-background/0 transition-colors duration-200 group-hover:cursor-pointer group-hover:bg-card-foreground/8 group-data-open:bg-card-foreground/8 dark:group-hover:bg-foreground/8' />
      ...
      <AccordionTrigger
        ...
        className='focus-visible:ring-card-foreground/45 dark:data-[state=open]:text-card-foreground [&>svg]:text-card-foreground/70 relative z-10 min-h-14 items-center px-5 py-4 text-card-foreground transition-colors duration-200 hover:text-card-foreground hover:no-underline focus-visible:ring-2 focus-visible:ring-card-foreground/45 data-[state=open]:text-card-foreground sm:px-6 [&>[&>svg]:text-card-foreground/70'
      >
        <div className='flex items-center gap-4'>
          <div
            className='border-card-foreground/24 flex size-10 items-center justify-center rounded-full border border-card-foreground/24 bg-card text-card-foreground transition-transform duration-200 group-hover:scale-105'
