...
export function ProductDetailsAccordionSection({
  ...
  return (
    ...
    >
      <div className='dark:bg-dark-background/0 dark:group-hover:bg-dark-card-foreground/8 dark:group-data-open:bg-dark-card-foreground/8 pointer-events-none absolute inset-0 z-0 bg-background/0 transition-colors duration-200 group-hover:cursor-pointer group-hover:bg-card-foreground/8 group-data-open:bg-card-foreground/8' />
