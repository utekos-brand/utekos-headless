...
export function ProductPageSkeleton() {
  return (
    <article className='bg-muted relative isolate overflow-hidden py-10 md:py-14'>
      <div className='pointer-events-none absolute inset-0 -z-10'>
        <div className='absolute top-12 left-[8%] h-80 w-80 rounded-full bg-[radial-gradient(circle,color-mix(in_oklab,var(--secondary)_62%,transparent)_0%,transparent_72%)] blur-3xl' />
            ...
            <div className='rounded-3xl border border-foreground/70 bg-foreground/72 p-6 md:mt-6'>
              <div className='mt-10 space-y-8'>
                <div className='space-y-2'>
                  <Skeleton className='bg-muted/80 h-4 w-20' />
                  <Skeleton className='bg-muted/80 h-10 w-full' />
                </div>
                <div className='space-y-2'>
                  <Skeleton className='bg-muted/80 h-4 w-20' />
                  <Skeleton className='bg-muted/80 h-10 w-full' />
              ...
              <Skeleton className='bg-muted/80 mt-8 h-12 w-full' />
              <div className='mt-12 space-y-3'>
                <Skeleton className='bg-muted/80 h-4 w-full' />
                <Skeleton className='bg-muted/80 h-4 w-full' />
                <Skeleton className='bg-muted/80 h-4 w-5/6' />
              </div>
            </div>
          </OptionsColumn>
        </ProductPageGrid>
