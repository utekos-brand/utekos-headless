  ...
  return (
    ...
    >
      <div className='absolute inset-0 -z-10 pointer-events-none overflow-hidden'>
        ...
        <div className='motion-blob-1 absolute left-[30%] top-[20%] size-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-bleached-mauve blur-[120px] mix-blend-screen' />
      ...
      <div className='relative z-10 container mx-auto px-4 flex flex-col items-center'>
        <div className='motion-icon-wrapper mb-10 will-change-transform'>
          <div className='motion-icon-glow flex h-16 w-16 items-center justify-center rounded-full border border-white/10 bg-bleached-mauve/80 shadow-[0_0_15px_rgba(255,255,255,0.05)] backdrop-blur-sm'>
        ...
        <h2 className='text-balance text-4xl font-bold   sm:text-5xl md:text-7xl leading-tight'>
          <span className='block overflow-hidden'>
            <span className='motion-title-line text-havdyp block will-change-transform'>Skapt for</span>
          </span>
        ...
        <p className='motion-text opacity-0 mx-auto max-w-2xl text-lg leading-relaxed text-background/90 dark:text-dark-background/90 md:text-xl font-light'>
          Våre komfortplagg er{' '}
          <span className='relative inline-block text-background dark:text-dark-background font-medium'>
            designet
          ...
          <span className='relative inline-block px-1'>
            <span className='motion-desc-highlight absolute inset-0 -skew-x-6 text-background/90 dark:text-dark-background/90 rounded bg-white/10 origin-left scale-x-0' />
            <span className='relative z-10 font-medium text-background/90 dark:text-dark-background/90'>nyte</span>
          </span>{' '}
