...
export function NbccFinalCtaSection() {
  return (
    <article className='relative overflow-hidden bg-muted px-4 py-20 sm:px-6 lg:px-8'>
      ...
      >
        <p className='text-sm font-semibold tracking-[0.18em] text-background uppercase'>
          Klar for neste campingtur
        </p>
        <h2 className='mt-4 max-w-3xl font-sans text-4xl text-balance text-background *:font-semibold sm:text-5xl'>
        ...
        <Button
          ...
          size='lg'
          className='mt-9 h-12 rounded-md bg-primary px-6 text-[15px] font-semibold text-background hover:bg-primary/90 hover:bg-primary/90'
        >
          <Link
