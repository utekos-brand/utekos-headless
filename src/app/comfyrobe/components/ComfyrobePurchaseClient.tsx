      ...
      <div className='grid min-h-[760px] lg:grid-cols-2'>
        ...
        <div className='flex flex-col'>
          <div className='flex-1 bg-background px-6 py-14 text-foreground md:px-12 lg:px-16 lg:py-20'>
            ...
            <h2
              id='purchase-heading'
              className='mt-3 font-sans text-5xl leading-[0.92] font-bold tracking-[-0.02em] text-foreground md:text-6xl'
            >
              Tøff ute. Myk på innsiden.
            </h2>
            <p className='mt-6 max-w-xl font-utekos-text text-lg leading-relaxed text-foreground'>
              Finn din størrelse og velg mellom våre fleksible
              betalingsmuligheter.
            </p>
            ...
            <div className='mt-8 flex flex-wrap items-end gap-x-4 gap-y-2'>
              ...
              {savings && selectedVariant.compareAtPrice ?
                <>
                  ...
                  <BrandBadge
                    tone='promo'
                    className='mb-1 h-8 px-3 py-0 text-xs font-bold'
                  >
                    Spar{' '}
                    {formatMoney(
                      savings.amount,
            ...
            <div className='mt-10 grid gap-4 sm:grid-cols-2'>
              {color ?
                <div className='rounded-2xl border border-foreground/15 p-4'>
                  ...
                  <span className='mt-1 block font-utekos-text-medium'>
                    {color}
                  </span>
                </div>
              : null}
            ...
            {sizeOption ?
              <fieldset className='mt-10'>
                <div className='flex items-center justify-between gap-4'>
                  <legend className='font-utekos-text-medium'>
                    Størrelse
                  </legend>
                  <Link
                  ...
                  >
                    <Ruler className='size-4' aria-hidden /> Se
                    størrelsesguide
                  </Link>
                </div>
                <div
                  ...
                  {sizeOption.optionValues.map(optionValue => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() =>
                          available &&
                          updateVariant(sizeOption.name, value)
                        }
                        className={[
                      ...
                      >
                        ...
                        {!available ?
                          <span className='mt-1 block text-[10px] tracking-wide uppercase'>
                            Utsolgt
                          </span>
                        : null}
                      </button>
          ...
          <div className='border-t border-background/15 bg-card p-6 text-card-foreground md:p-10'>
            ...
            <p className='mt-5 text-center text-sm text-card-foreground/70'>
              Rask levering · Sikker betaling · 14 dagers retur
            </p>
          </div>
        </div>
      </div>
