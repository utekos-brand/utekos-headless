...
import { handleCanonicalFormErrorRequest } from '@/lib/analytics/server/handleCanonicalFormErrorRequest'
import { handleCanonicalFormErrorRoute } from '@/lib/analytics/server/handleCanonicalFormErrorRoute'
...
export function POST(request: Request) {
  return handleCanonicalFormErrorRoute(request, {
    collect: currentRequest =>
      handleCanonicalFormErrorRequest(currentRequest, {
