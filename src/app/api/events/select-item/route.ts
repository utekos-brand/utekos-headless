...
import { handleCanonicalSelectItemRequest } from '@/lib/analytics/server/handleCanonicalSelectItemRequest'
import { handleCanonicalSelectItemRoute } from '@/lib/analytics/server/handleCanonicalSelectItemRoute'
import { postgresCanonicalEventStore } from '@/lib/analytics/server/postgresCanonicalPageViewStore'

export const maxDuration = 60

export function POST(request: Request) {
  return handleCanonicalSelectItemRoute(request, {
    collect: currentRequest =>
      handleCanonicalSelectItemRequest(currentRequest, {
