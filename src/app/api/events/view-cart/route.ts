...
import { handleCanonicalViewCartRequest } from '@/lib/analytics/server/handleCanonicalViewCartRequest'
import { handleCanonicalViewCartRoute } from '@/lib/analytics/server/handleCanonicalViewCartRoute'
...
export function POST(request: Request) {
  return handleCanonicalViewCartRoute(request, {
    collect: currentRequest =>
      handleCanonicalViewCartRequest(currentRequest, {
