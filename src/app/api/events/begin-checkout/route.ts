...
import { handleCanonicalBeginCheckoutRequest } from '@/lib/analytics/server/handleCanonicalBeginCheckoutRequest'
import { handleCanonicalBeginCheckoutRoute } from '@/lib/analytics/server/handleCanonicalBeginCheckoutRoute'
...
export function POST(request: Request) {
  return handleCanonicalBeginCheckoutRoute(request, {
    collect: currentRequest =>
      handleCanonicalBeginCheckoutRequest(currentRequest, {
