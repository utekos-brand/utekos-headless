...
import { handleCanonicalSizeGuideViewRequest } from '@/lib/analytics/server/handleCanonicalSizeGuideViewRequest'
import { handleCanonicalSizeGuideViewRoute } from '@/lib/analytics/server/handleCanonicalSizeGuideViewRoute'
...
export function POST(request: Request) {
  return handleCanonicalSizeGuideViewRoute(request, {
    collect: currentRequest =>
      handleCanonicalSizeGuideViewRequest(currentRequest, {
