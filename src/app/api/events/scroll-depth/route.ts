...
import { handleCanonicalScrollDepthRequest } from '@/lib/analytics/server/handleCanonicalScrollDepthRequest'
import { handleCanonicalScrollDepthRoute } from '@/lib/analytics/server/handleCanonicalScrollDepthRoute'
...
export function POST(request: Request) {
  return handleCanonicalScrollDepthRoute(request, {
    collect: currentRequest =>
      handleCanonicalScrollDepthRequest(currentRequest, {
