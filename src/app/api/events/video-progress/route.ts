...
import { handleCanonicalVideoProgressRequest } from '@/lib/analytics/server/handleCanonicalVideoProgressRequest'
import { handleCanonicalVideoProgressRoute } from '@/lib/analytics/server/handleCanonicalVideoProgressRoute'
...
export function POST(request: Request) {
  return handleCanonicalVideoProgressRoute(request, {
    collect: currentRequest =>
      handleCanonicalVideoProgressRequest(currentRequest, {
